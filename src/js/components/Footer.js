            ...
            <div class="max-w-screen-custom mx-auto flex flex-wrap justify-between items-start text-white">
                ...
                <div class="w-full md:w-1/2 lg:w-1/4 mt-10 lg:mt-0 px-5">
                    ...
                    <ul class="link-wrapper mt-5 lg:mt-14 text-custom">
                        <li class="py-1"><a href="#">Kabupaten Pekalongan</a></li>
                        <li class="py-1"><a href="#">Provinsi Jawa Tengah</a></li>
                        <li class="py-1"><a href="#">Kementrian Kominfo</a></li>
                        <li class="py-1"><a href="#">Kementrian Hukum & HAM</a></li>
                    </ul>
                </div>
                ...
                <div class="w-full md:w-1/2 lg:w-1/4 mt-10 md:mt-16 lg:mt-0 px-5">
                    ...
                    <ul class="link-wrapper mt-5 lg:mt-14 text-custom">
                        <li class="py-1"><a href="#">Berita</a></li>
                        <li class="py-1"><a href="#">Fraksi</a></li>
                    </ul>
                </div>
                <!-- END : Single Item -->
            </div>
